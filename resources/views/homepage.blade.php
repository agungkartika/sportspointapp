...
@section('content')
            ...
            @foreach ($posts as $post)
                <div class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105">
                    ...
                    <div class="p-6">
                        ...
                        <a href="{{ route('artikel.show', ['slug' => $post->slug]) }}"
                            class="mt-4 inline-block text-blue-600 hover:text-blue-400 font-semibold transition-colors">Read
                            more</a>
                    </div>
                </div>
            @endforeach
    ...
    <div class="pt-20">
        <div
            class="relative w-full h-[500px] flex items-center justify-center text-center bg-cover bg-center rounded-lg shadow-md overflow-hidden">
    ...
    <div class="container mx-auto px-6 md:px-12 mt-12 text-center">
        ...
        <p class="mt-6 text-gray-700 text-lg md:text-xl">
            Sport Points merupakan sebuah blog yang memberikan informasi terbaru mengenai peralatan olahraga yang sedang
            hype atau trending. Blog ini mencakup dari berbagai jenis olahraga, mulai dari jenis olahraga fitness, lari,
            bersepeda, hingga olahraga tim seperti sepak bola dan basket.
        </p>
    </div>
@endsection
