...
@section('content')
    ...
    <div class="container-fluid mx-auto  md:px-12 mt-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Main Content -->
            <div class="md:col-span-2 ">
                <div class="shadow-lg rounded-lg overflow-hidden"><h1 class="p-6 text-4xl font-bold text-gray-900">{{ $post->title }}</h1>
