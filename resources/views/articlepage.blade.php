    ...
    <div class="container mx-auto px-6 py-20">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <div class="space-y-4">
                    @foreach ($trendingPosts as $posts)
                        <div class="bg-white rounded-lg shadow-md overflow-hidden p-4 flex items-center gap-4">
                            <img src="{{ asset($posts->image) }}" alt="Trending Image"
                                class="w-16 h-16 object-cover rounded">
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900">{{ $posts->title }}</h3>
                                <a href="{{ route('artikel.show', $posts->slug) }}"
